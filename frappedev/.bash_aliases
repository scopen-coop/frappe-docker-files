...
_bench_completion() {
    ...
    if [ -d "sites" ]; then
        ...
        COMPREPLY+=( $( COMP_WORDS="bench frappe "${COMP_WORDS[@]:1} \
                        ...
                        _BENCH_COMPLETE=complete /workspace/development/frappe-bench/env/bin/python /workspace/development/frappe-bench/apps/frappe/frappe/utils/bench_helper.py ) )
