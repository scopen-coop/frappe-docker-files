...
/home/..../frappe_docker_16 => clone of https://github.com/frappe/frappe_docker
...
```sh
docker exec -e "TERM=xterm-256color" -w /workspace/development -it frappe16_frappe_1 bash
```
